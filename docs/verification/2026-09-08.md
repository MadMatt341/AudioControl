...
Historical record, preserved from the original VERIFICATION.md. Results below
describe successive local checks, not verification of the current checkout.
For current procedures, use [development](../development.md) and
...
- GitHub workflow configured for Windows Server 2022 and 2025 builds/tests. It
  ...
  additional client Windows builds still requires the [compatibility checklist](../compatibility.md).
